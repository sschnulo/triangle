...
def plotVelocityTriangles():
    ...
    pylab.arrow( offsetx, offsety, dx, dy, width=6, head_width=40,
    ...
    offsetx = lastx + 1.15*( 400. * numpy.cos( BR ['bladeAngleOut'] ) )
    offsety = lasty - 1.15*( 400. * numpy.sin( BR ['bladeAngleOut'] ) )
